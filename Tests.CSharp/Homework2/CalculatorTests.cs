...
public class CalculatorTests
{
    ...
    {
        //act
        var actual = Hw2.Calculator.Calculate(10, CalculatorOperation.Divide, 0);
    ...
    {
        //act
        var actual = Hw2.Calculator.Calculate(0, CalculatorOperation.Divide, 10);
    ...
    {
        //act
        var actual = Hw2.Calculator.Calculate(0, CalculatorOperation.Divide, 0);
