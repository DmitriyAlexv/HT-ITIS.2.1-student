...
public class MemoryTest : IClassFixture<WebApplicationFactory<Cached.Program>>
    // TODO: replace MemoryTest with the right generic argument
{
    private readonly HttpClient _client;
    private readonly ITestOutputHelper _output;

    public MemoryTest(WebApplicationFactory<Cached.Program> factory, ITestOutputHelper output)
    {
        _output = output;
